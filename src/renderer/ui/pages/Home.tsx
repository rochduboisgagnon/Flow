...
// ---------------------------------------------------------------------------
// 2026-08-04 : DEUX CARTES SUR TROIS SONT PARTIES (demande de Roch)
// ---------------------------------------------------------------------------
//
// « Dans le menu Home, enleve la section Speech engine, puis la section Long
// recording, puis en faisant ca, ca va pouvoir elargir la section Dictation, puis
// la section Dictation, mais la plus slim. »
//
// CE QUE CHACUNE PORTAIT, ET OU ON LE TROUVE MAINTENANT :
//
//   Speech engine    -> l'etat du moteur et son backend. Le POINT et le mot
//                       « Armed / Listening » de la carte qui reste disent deja
//                       si la dictee peut partir ; le nom du backend et la barre
//                       de telechargement du modele sont dans Settings > Engine,
//                       qui a une rangee pour chacun.
//   Long recording   -> l'etat d'un enregistrement en cours et la derniere
//                       capture. La page Record montre le premier en direct (avec
//                       son minuteur et ses notes), la page Notes liste la
//                       seconde. C'etait la seule carte a montrer un
//                       enregistrement en cours ; ce n'est plus la seule surface
//                       a le faire, sinon je ne l'aurais pas retiree.
//
// La carte qui reste tient donc toute la largeur, et elle a MAIGRI : le ruban
// animé est parti avec elle. Il occupait 22 pixels de marge et une hauteur de
// 40 pour repeter, au repos, ce que le point vert dit deja - et sur une carte
// pleine largeur il devenait une bande decorative traversant l'ecran.
//
          ...
          {healed ? (
            <p className="sub" style={{ margin: "6px 0 0" }}>
              {/* La derniere phrase disait « See Diagnostics. » : cette page n'existe
                  plus (2026-08-04). Elle est remplacee par ce que quelqu'un peut
                  vraiment faire de l'information, et non par un renvoi mort. */}
